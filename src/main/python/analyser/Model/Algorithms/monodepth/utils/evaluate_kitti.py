...
parser.add_argument(
    "--split", type=str, help="data split, kitti or eigen", required=True
)
parser.add_argument(
    "--predicted_disp_path",
    type=str,
...
if __name__ == "__main__":
    ...
    if args.split == "kitti":
        ...
        ) = convert_disps_to_depths_kitti(gt_disparities, pred_disparities)
        ...
        for t_id in range(num_samples):
            ...
            focal_length, baseline = get_focal_length_baseline(
